      ...
      <div className="flex p-7 rounded-lg bg-gray-100">
        <div>
          <div className="flex justify-between">
            <p className="text-2xl font-bold">こころ</p>
            <button className="w-24 h-10 ml-12 rounded text-xs bg-blue-500">
              <Image className="mx-auto" src="/edit.svg" width={20} height={20} alt="edit" />
              <p className="text-white">Edit</p>
            </button>
          </div>
          <div className="flex justify-between mt-5">
            <p className="w-96 h-96 p-5 overflow-y-scroll rounded bg-white">
